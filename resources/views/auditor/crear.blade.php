@extends('layouts.app')
@section('title')
    MyControlSMA-Crear auditoria
@endsection
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Crear auditoria médica</h3>
        </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="id_oservicio" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-4">
                                        ...
                                        <div class="form-floating">
                                            ...
                                            <input type="number" name="id_facturacion" class="form-control">

                                        </div><br><br>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-2">
                                        <div class="form-group">
                                            <label for="aprobada_auditoria">Estado</label>
                                            <select type="text" class="form-control" name="aprobada_auditoria"
                                                id="aprobada_auditoria">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-2">
                                        <div class="form-group">
                                            ...
                                            <?php $fcha = date("Y-m-d");?>
                                            <input type="date" name="fec_apr_auditoria" class="form-control"value="<?php echo $fcha;?>">
